...
{
  	long angle_with_formula;
	angle_with_formula = (((gyro_angle * GYRO_SENSITIVITY * 5L) / (ADC_RANGE * ADC_UPDATE_RATE)) * GYRO_CAL_FACTOR);
	//printf("Angle AFTER formula %li \r\r", angle_with_formula);
